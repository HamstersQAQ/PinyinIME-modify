...
public class SkbContainer extends RelativeLayout implements OnTouchListener {
    ...
    private void updateSkbLayout() {
        ...
        switch (mSkbLayout) {
            case R.xml.skb_qwerty:
                ...
                setBackgroundResource(R.drawable.skb_container_bg);
                break;

            case R.xml.skb_sym1:
                majorSkb = skbPool.getSoftKeyboard(R.xml.skb_sym1, R.xml.skb_sym1,
                        screenWidth, skbHeight, getContext());
                setBackgroundResource(R.drawable.skb_container_sym_bg);
                break;
    ...
    public void changeBackground(int inputMode) {
        switch (inputMode) {
            case InputModeSwitcher.MODE_SKB_CHINESE:
                setBackgroundResource(R.drawable.skb_container_cn_bg);
                break;
            case InputModeSwitcher.MODE_SKB_SYMBOL1_CN:
                setBackgroundResource(R.drawable.skb_container_sym_bg);
                break;
            default:
                setBackgroundResource(R.drawable.skb_container_bg);
