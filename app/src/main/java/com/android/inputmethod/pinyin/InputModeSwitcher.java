...
public class InputModeSwitcher {
    ...
    public int requestInputWithHkb(EditorInfo editorInfo) {
        ...
        if (english) {
            ...
            newInputMode = MODE_HKB_ENGLISH;
            Log.d(getClass().getSimpleName(), "requestInputWithHkb: English");
        } else {
...
//                Log.d(getClass().getSimpleName(), "requestInputWithHkb: Chinese");
//            } else {
                newInputMode = MODE_HKB_ENGLISH;
                Log.d(getClass().getSimpleName(), "requestInputWithHkb: English");
//            }
...
//                        newInputMode = MODE_SKB_CHINESE;
//                        Log.d(getClass().getSimpleName(), "requestInputWithSkb: Chinese");
//                    } else {
                        newInputMode = MODE_SKB_ENGLISH_LOWER;
                        Log.d(getClass().getSimpleName(), "requestInputWithSkb: English Lower");
//                    }
                }
            }
            break;
        default:
            ...
            if (0 == skbLayout) {
                if ((mInputMode & MASK_LANGUAGE) == MASK_LANGUAGE_CN) {
                    newInputMode = MODE_SKB_CHINESE;
                    Log.d(getClass().getSimpleName(), "requestInputWithSkb: Chinese Default");
                } else {
                    newInputMode = MODE_SKB_ENGLISH_LOWER;
                    Log.d(getClass().getSimpleName(), "requestInputWithSkb: English Lower Default");
                }
            }
            break;
        }
    ...
    private void saveInputMode(int newInputMode) {
        Log.d(getClass().getSimpleName(), "saveInputMode: " + newInputMode);
